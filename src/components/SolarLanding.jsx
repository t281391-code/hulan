...
const SolarLanding = () => {
  ...
  return (
    <div className="h-screen w-screen bg-black relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-start sm:justify-end pt-4 sm:pt-0 pb-0 sm:pb-8 md:pb-12 lg:pb-16">
        <div className="relative bg-black/95 backdrop-blur-0 sm:backdrop-blur-md border-2 sm:border-2 border-orange-500 rounded-lg sm:rounded-xl shadow-2xl mx-3 sm:mx-4 md:mx-6 animate-mobile-overlay-slide sm:animate-pulse w-auto sm:w-auto max-w-md overflow-hidden">
          {/* Text content */}
          <div className="relative px-4 sm:px-6 md:px-8 lg:px-10 py-2 sm:py-4 md:py-5 lg:py-6">
            <div className="text-orange-400 sm:text-orange-500 text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold font-mono tracking-[0.1em] sm:tracking-[0.2em] md:tracking-[0.3em] text-center leading-tight" style={{ textShadow: '0 0 20px rgba(251, 146, 60, 1), 0 0 40px rgba(251, 146, 60, 0.8), 0 0 60px rgba(251, 146, 60, 0.6)' }}>
